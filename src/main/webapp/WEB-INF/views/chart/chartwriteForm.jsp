...
<body>
		...
		<div class="chartwrite_box">
			<form action="chartwrite" method="post">
				<table class="container">
					<tr>
						<th>이름</th>
						<td><input type="text" name="cname" id="inid"
							placeholder="환자 이름을 입력해주세요."></td>
						<th>진료과</th>
						<td>${chart.md}</td>
					</tr>
					<tr>
						<th>주민번호</th>
						<td><input type="text" name="rrn" id="inrrn"
							placeholder="환자 주민번호를 입력해주세요."></td>
						<th>병명</th>
						<td><input type="text" name="disease" id="indis"
							placeholder="환자 병명을 입력해주세요."></td>
					</tr>
					<tr id="va">
						<th>입원날짜</th>
					...
					<tr>
						<th>상태 및 소견</th>
						<td colspan="4" class="chart_memo"><textarea cols=""
								name="operation" id="inoper"
								style="width: 798px; height: 392px;"></textarea></td>
					</tr>
				</table>
	...
	<script>
		document.getElementById('inoperd').value = new Date().toISOString()
				.substring(0, 10);
		;
