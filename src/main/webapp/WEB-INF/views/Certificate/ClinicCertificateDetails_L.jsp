...
<!-- 진룍확인서 -->
<link rel="stylesheet"
	href="/resources/css/Certificate/ClinicCertificateDetails.css">
...
<body>
	...
	<ul id = "container">
		...
		<c:forEach items="${list}" var="chartlist">
			<li><a class="detailc" href = "#" id="db_move"><input type="hidden" name="db" value="${chartlist.db}">${chartlist.disease}</a>${chartlist.dn}/${chartlist.docname}(${chartlist.dn})</li>
		</c:forEach>
	</ul>
