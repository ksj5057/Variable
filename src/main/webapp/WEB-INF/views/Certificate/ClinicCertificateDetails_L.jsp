...
<!-- 헤더 -->
	...
	<ul>
			<li class="posi2"><a href ="ClinicCertificateDetails_Lr?db=${chartlist.db}" >${chartlist.disease}</a></li>
			<li id="lines" class="posi2"><a href ="ClinicCertificateDetails_Lr?db=${chartlist.db}">${chartlist.dn}</a> </li>
			<li class="posi2" id="px3"><a href ="ClinicCertificateDetails_Lr?db=${chartlist.db}">${chartlist.md}(${chartlist.docname})</a></li>
	</ul>
		</c:forEach>
